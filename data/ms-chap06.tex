...
\msttableentry{6.1}{镇街尺度的 POI、核心文化载体与指数均值对比}
...
\msttableentry{6.2}{500 m 网格 0 跳 / 1 跳错位分类对比}
...
\msttableentry{6.3}{镇街尺度 1 跳知识图谱口径摘要}
...
\msttableentry{6.4}{载体级指标相关矩阵（Pearson, n = 165）}
...
\msttableentry{6.5}{镇街级指标相关矩阵（Pearson, n = 7）}
...
\msttableentry{6.6}{政策可干预条件与基础约束条件的划分}
...
\msttableentry{6.8}{镇街典籍---官方---旅游诊断拆分摘要}
...
\begin{table}[H]
\centering
\msttableentry{6.10}{游客评论文化识别知识图谱补充检验结果}
...
\begin{table}[H]
\centering
\msttableentry{6.11}{重点载体评论文化识别度抽样结果}
