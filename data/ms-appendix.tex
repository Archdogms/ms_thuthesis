...
官方资源扩展层总量为 593 条，其中包括 484 处不可移动文物、11 家博物馆和 98 条历史建筑、传统村落、历史文化名村、历史文化街区等历史文化资源。该扩展层用于官方资源覆盖校验、诊断拆分和后续人工核查，不直接替代本论文 165 条核心指数计算样本；主分析仍以具备稳定名称、类型和空间锚点的 165 条载体为准。
