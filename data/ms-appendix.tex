...
本研究在实体抽取阶段采用``双重标签''体系：第一层为面向地方文化记忆识别的研究分类标签，分为 6 个一级体系、28 个二级类型；第二层为便于同官方资源名录衔接的官方分类标签。前者用于保证典籍文本中的人物、空间、技艺、文献和历史时序能够被完整识别，后者用于和非遗名录、文物保护单位、历史文化名镇名村、公共文化资源等管理口径发生对应。
...
完整载体级指数表以 \texttt{output/tables/indices\_anchors.csv} 作为电子附表留存；本附录仅概述类型和镇街分布，附录 C 摘录典型样本。

官方资源扩展底表总量为 593 条，其中包括 484 处不可移动文物、11 家博物馆和 98 条历史建筑、传统村落、历史文化名村、历史文化街区等历史文化资源。该底表是后期补充整理的数据，尚未完成与 165 条核心样本同等口径的清洗、去重、坐标校核和 POI / 评论匹配，因此仅作为后续清洗、比对和扩展主体样本的资料基础，不直接替代 165 条主体计算样本。

\chapter{载体级指数与错位分类样例}

附录 C 不展开 165 条全量表，而是摘录三类最能说明错位结构的代表样本。完整载体级指数表仍以 \texttt{output/tables/indices\_anchors.csv} 作为电子附表留存。
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.34\textwidth}>{\centering\arraybackslash}p{0.12\textwidth}>{\centering\arraybackslash}p{0.09\textwidth}>{\centering\arraybackslash}p{0.09\textwidth}>{\centering\arraybackslash}p{0.09\textwidth}>{\centering\arraybackslash}p{0.09\textwidth}@{}}
\toprule
...
\bottomrule
\endlastfoot
西樵镇松塘村 & 西樵镇 & 80.39 & 100.00 & 4.48 & −85.72 \\
九江镇烟桥烟南村 & 九江镇 & 84.51 & 100.00 & 7.09 & −85.16 \\
丹灶镇仙岗社区 & 丹灶镇 & 69.35 & 100.00 & 4.48 & −80.20 \\
赛龙舟（九江传统龙舟） & 九江镇 & 78.11 & 75.00 & 0.00 & −76.55 \\
西樵山仙姑亭 & 西樵镇 & 98.55 & 50.00 & 0.00 & −74.28 \\
丹灶镇南沙棋盘村 & 丹灶镇 & 70.98 & 75.00 & 0.00 & −72.99 \\
丹灶镇棋盘村 & 丹灶镇 & 70.98 & 75.00 & 0.00 & −72.99 \\
九江镇烟桥村 & 九江镇 & 84.77 & 75.00 & 7.09 & −72.79 \\
西樵镇百西村头村 & 西樵镇 & 80.91 & 75.00 & 7.09 & −70.86 \\
丹灶镇仙岗村 & 丹灶镇 & 70.47 & 75.00 & 4.48 & −68.26 \\
\end{longtable}
\endgroup
...
\bottomrule
\endlastfoot
南海农谚 & 桂城街道 & 0.00 & 25.00 & 87.87 & 75.37 \\
南海广式旺阁酱油酿造技艺 & 桂城街道 & 0.00 & 25.00 & 70.00 & 57.50 \\
大伸市 & 九江镇 & 0.00 & 0.00 & 54.82 & 54.82 \\
光分亭 & 西樵镇 & 0.00 & 50.00 & 77.57 & 52.57 \\
红棉公园民国建筑群 & 九江镇 & 0.00 & 0.00 & 51.30 & 51.30 \\
沙基圩 & 西樵镇 & 0.00 & 0.00 & 46.88 & 46.88 \\
湖山胜迹门楼 & 西樵镇 & 14.70 & 50.00 & 78.27 & 45.92 \\
禄舟万寿堂 & 西樵镇 & 0.00 & 50.00 & 67.96 & 42.96 \\
大桐圩 & 西樵镇 & 0.00 & 0.00 & 42.58 & 42.58 \\
西联村神诞 & 桂城街道 & 0.00 & 25.00 & 55.07 & 42.57 \\
\end{longtable}
\endgroup
...
\bottomrule
\endlastfoot
云泉仙馆 & 西樵镇 & 70.25 & 75.00 & 77.78 & 5.15 \\
西樵山百步云梯 & 西樵镇 & 98.58 & 50.00 & 66.51 & −7.78 \\
西樵山抗日阵亡将士暨死难同胞纪念碑 & 西樵镇 & 98.61 & 50.00 & 65.58 & −8.73 \\
九江吴家大院 & 九江镇 & 69.28 & 75.00 & 66.04 & −6.10 \\
平洲传统玉器制作技艺 & 桂城街道 & 57.28 & 50.00 & 56.63 & 2.99 \\
\end{longtable}
\endgroup
...
\item
  OAI\_mean × THI\_mean（镇街级）: Pearson r = 0.702（提示官方认定与 THI 均值存在同向关系）。
\end{itemize}
